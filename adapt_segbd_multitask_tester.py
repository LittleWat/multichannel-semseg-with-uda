...
from models.model_util import get_segbd_multitask_models
...
model_enc, model_dec = get_segbd_multitask_models(net_name=train_args.net, input_ch=train_args.input_ch,
...
for index, (imgs, _, paths) in tqdm(enumerate(target_loader)):
    ...
    pred_semseg1, pred_semseg2, pred_boundary = model_dec(feature)
