...
parser.add_argument('--outdir', type=str, default="vis_RGBX_GT")
...
if not args.pick_up:
    ...
    if args.dataset == "city":
        ...
        # ['01230N.png', '01356N.png', '01239N.png']
...
def concat_imgs(imgs):
    ...
    for row in range(n_row):
        for col in range(n_col):
            merged_img.paste(imgs[row][col], (w * col, h * row))
